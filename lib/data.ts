...
export const alumniProfiles: AlumniProfile[] = [
  {
    ...
    openToContact: true,
    bookmarked: false,
    email: "notleakinghisemail@email.com",
    phone: "(555) 123-4567",
    linkedIn: "https://linkedin.com/in/terencepae",
    about: "Generalist Software Engineer with entrepreneurial background.",
    companies: [
    ...
    experience: [
      {
        company: "NiftyKit",
        role: "CTO / Co-Founder (Acquired)",
        startDate: "Dec 2022",
        endDate: "Apr 2025",
        description: "Acquired in April 2025, by Kaikai Kiki Ltd. Pioneered a no-code NFT smart contract platform with over 100,000 creators, facilitating more than $25 million in NFT sales. Launched 5,000+ NFT drops through a self-serve platform, significantly accelerating creators' time-to-market. Partnered with prestigious brands like Gucci, Kaikai Kiki (Takashi Murakami), Macy's, NBCUniversal, U.S. Army, and Christie's Auctions to deliver custom NFT solutions. Led a cross-functional team, fostering a culture of innovation and excellence, driving company growth.",
      },
      {
        company: "Netflix",
        ...
        startDate: "Dec 2019",
        endDate: "May 2022",
        description: "Working on cutting-edge Studio UI for production planning. Created Studio Planning UI tools with TypeScript/React/GraphQL. Contributed to internal tooling for developer productivity. Actively participated in speaking opportunities and product demos with cross-functional teams.",
      },
      {
        company: "Tesla",
        role: "Senior Software Engineer",
        startDate: "Jan 2017",
        endDate: "Dec 2019",
        description: "Accelerating sustainable energy. Part of a mission-critical team in launching Model 3, worked on building a distributed system to manage options, pricing, and translations. Created CI/CD pipeline on Amazon Web Services using Terraform, Docker, and Jenkins. Created an internal design system library in React to promote developer productivity. Created internal UI tools to help with data integrity and customer order flow. I left the company between January 2019 and August 2019 to pursue a startup. I was rehired for a few months to work on pricing architecture.",
      },
      {
        ...
        startDate: "Jun 2014",
        endDate: "Jan 2017",
        description: "Specialized in cross platform development (Web, Mobile Web, and iOS). Focused on creating value-driven, high revenue impact products, and delivered successful results with fast execution. Created and launched Trulia's mortgage long form on multiple platforms (desktop web, mobile web, and iOS). Created and launched Trulia's mortgage iOS app, written in Swift. Featured as Apple's Best New App in 2016, received company wide recognition. Created and launched mortgage calculator on Desktop and Mobile Web, written in React + Redux. Created and launched mortgage calculator features on Trulia iOS app.",
      },
    ],
    education: [
      {
